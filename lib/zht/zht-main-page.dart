            ...
            Row(       
              ...
              children: <Widget>[
               ...
               /*      Container( 
                        ...
                        height: HEIGHT,
                        child: OutlineButton.icon(    
                          label: Text("Starting location",style: new TextStyle(fontSize:TEXT_SIZE)),
                          icon:Icon(Icons.my_location, color:Colors.grey,size: ICON_SIZE,),
                          onPressed: (){
                            setState(() {
                              whoSelected=0;
                              ICI = 1.0;
                   ...
                   // ),
                    /*Align(
                     ...
                     alignment: Alignment.bottomCenter,
                      child:Container(
                        ...
                        height: HEIGHT,
                        child: OutlineButton.icon(
                          label: Text("Current location ",style: new TextStyle(fontSize:TEXT_SIZE)),
                          icon:Icon(Icons.my_location, color:Colors.grey, size: ICON_SIZE,),
                          onPressed: (){
                            setState(() {
                              whoSelected=1;
                    ...
                    Align(
                      ...
                      child:Container(    
                        ...
                        height: HEIGHT,
                        child: OutlineButton.icon(       
                          label: Text("Setting",style: new TextStyle(fontSize:TEXT_SIZE)),
                          icon:Icon(Icons.settings, color:Colors.grey,size: ICON_SIZE,),
                          onPressed: (){
                            setState(() {
                              whoSelected=2;
                              ICI = 2.0;
